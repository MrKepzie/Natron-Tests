...
TEST_DIRS="TestFrameBlend TestRetimeTransform TestTimeBlur TestTilePyPlug TestArc TestImplode TestPolar TestSwirl TestWave TestTexture TestCharcoal TestEdges TestOilpaint TestReflection TestRoll TestTile"
